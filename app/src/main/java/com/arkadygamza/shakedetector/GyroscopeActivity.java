...
//                VIEWPORT_SECONDS = i;
//                restartActivity(GyroscopeActivity.this,i);
//            }
//        });
////
////
...
////    }
////
//////    public void restartActivity(Activity activity, int i) {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            switch (id) {
                ...
                case R.id.line_accelerometr_geroscope:
                    Intent i = new Intent(GyroscopeActivity.this,AccelerGyrosActivity.class);
                    startActivity(i);
                    return true;
                default:
                    return true;
